package com.example.springkafkalistener;
...
public class SpringKafkaListenerApplication {
    public static final Logger logger = LoggerFactory.getLogger(SpringKafkaListenerApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(SpringKafkaListenerApplication.class, args);
    }
